...
public class Logout {
    private static final String TEMPLATE_FILE = "./LogoutTemplate.txt";
    ...
    public Logout(String techno) throws Exception {
    ...
    public String[] necessaryImport() throws Exception {
        ...
        try {
            ...
            if (databaseRefList != null) {
                ...
                NodeList elements = databaseRef.getElementsByTagName("utilImportLogout");
                if (elements != null) {
    ...
    public void generate(String className, String token) throws Exception {
        try {
            ...
            String impl = "implements LogoutHandler";
            ...
            template = template.replace("#CLASSNAME2#", capitalizeFirstLetter(token));
    ...
    private String attr() throws Exception {
        String attrs = this.getOneValue("attributionsLogout");
        return attrs;
    }

    private String log() throws Exception {
        String logouts = this.getOneValue("logout");
        return logouts; 
    }
    ...
    public String contents(String template) throws Exception {
        ...
        String logout = this.log();
        template = template.replace("#LOGOUT#", logout);
