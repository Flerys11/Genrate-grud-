...
public class ServiceConf {
    private static final String TEMPLATE_FILE = "./SecurityConfigTemplate.txt";
    ...
    private String bean;
    private String packageNameConfig;
    ...
    public ServiceConf(String techno) throws Exception {
    ...
    public void setParameter() throws Exception {
        ...
        this.packageNameConfig = this.getValue("util", "packageNameConfig");
    }
    ...
    public String[] necessaryImport() throws Exception {
        ...
        try {
            ...
            if (databaseRefList != null) {
                ...
                NodeList elements = databaseRef.getElementsByTagName("utilImportSecurityConfig");
                if (elements != null) {
    ...
    public void generate(String className) throws Exception {
        try {
            ...
            template = template.replace("##PACKAGE##", packageNameConfig);
            ...
            File folder = new File(packageNameConfig);
            if (!folder.exists()) {
                if (folder.mkdirs()) {
                    try (BufferedWriter writer = new BufferedWriter(
                            new FileWriter(packageNameConfig + "/" + className + extension))) {
    ...
    private String attr() throws Exception {
        String attrs = this.getOneValue("attributions");
        return attrs;
    }

    private String securityFilterChain() throws Exception {
        String sfc = this.getOneValue("SecurityFilterChain");
        return sfc;
    }

    private String passwordEncoder() throws Exception {
        String pwd = this.getOneValue("passwordEncoder");
        return pwd;
    }
    ...
    public String contents(String template) throws Exception {
        ...
        String sfc = this.securityFilterChain();
        template = template.replace("#FILTRE#", sfc);
        String pwd = this.passwordEncoder();
